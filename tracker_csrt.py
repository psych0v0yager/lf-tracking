"""
Robust Single Object Tracker - Version 17v9 (Balanced CSRT)

Changes from v17v9:
- Restore use_segmentation = True (needed for end-of-video tracking)
- Keep other speed optimizations:
...
def main():
    ...
    writer = None
    if not args.no_save:
        out_path = args.output or (Path(args.video).stem + "_tracked_v17v9.mp4")
