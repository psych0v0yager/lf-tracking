"""
Robust Single Object Tracker - Version 17v8 (Optimized CSRT)

Changes from v17v7:
- Optimized CSRT parameters for speed:
  - use_segmentation = False (biggest win, ~5-10ms)
  - number_of_scales = 17 (default 33)
  - template_size = 150 (default 200)
  - padding = 2.5 (default 3.0)
  - admm_iterations = 3 (default 4)
  - histogram_bins = 8 (default 16)
"""
...
def main():
    ...
    writer = None
    if not args.no_save:
        out_path = args.output or (Path(args.video).stem + "_tracked_v17v8.mp4")
