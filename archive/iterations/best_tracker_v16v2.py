"""
Robust Single Object Tracker - Version 16v2

Same as v16 but with detailed timing/latency logging for each step.

Usage:
    python best_tracker_v16v2.py test_track_dron1.mp4 1314 623 73 46
"""
...
def main():
    parser = argparse.ArgumentParser(description="Robust Object Tracker V16v2 with Timing")
    ...
    out_path = args.output or (Path(args.video).stem + "_tracked_v16v2.mp4")
    ...
    while True:
        ...
        # Display
        timing.start("imshow")
        cv2.imshow("Tracking V16v2", frame)
        timing.stop("imshow")
