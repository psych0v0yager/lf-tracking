"""
Robust Single Object Tracker - Version 17v10 (Aggressive CSRT with Segmentation)

Changes from v17v10:
- Keep use_segmentation = True (essential for accuracy)
- Push OTHER parameters harder for more speed:
  - number_of_scales = 9 (was 17, default 33)
  - template_size = 100 (was 150, default 200)
  - padding = 2.0 (was 2.5, default 3.0)
  - admm_iterations = 2 (was 3, default 4)
  - histogram_bins = 4 (was 8, default 16)
"""
...
def create_tracker():
    """Create CSRT tracker with aggressive speed params but keeping segmentation"""
    params = cv2.TrackerCSRT_Params()

    # Keep segmentation - essential for accuracy at end of video
    params.use_segmentation = True       # MUST keep for robustness

    # Push other parameters harder
    params.number_of_scales = 9          # Was 17, default 33
    params.template_size = 100           # Was 150, default 200
    params.padding = 2.0                 # Was 2.5, default 3.0
    params.admm_iterations = 2           # Was 3, default 4
    params.histogram_bins = 4            # Was 8, default 16

    return cv2.TrackerCSRT_create(params), "CSRT-aggressive"
...
def main():
    parser = argparse.ArgumentParser(description="Robust Object Tracker V17v8 (Optimized CSRT)")
    ...
    writer = None
    if not args.no_save:
        out_path = args.output or (Path(args.video).stem + "_tracked_v17v10.mp4")
    ...
    while True:
        ...
        if not args.no_show:
            timing.start("imshow")
            cv2.imshow("Tracking V17v8", frame)
            timing.stop("imshow")
