"""
Robust Single Object Tracker - Version 16v8 (Optimized Motion Est)

Changes from v16v7:
- Optimized CameraMotionEstimator:
  1. Downscales input to 320px width (huge speedup)
  2. Uses fixed Grid Sampling instead of goodFeaturesToTrack (removes detection cost)
  3. Reduced LK window size (11x11) and pyramid levels (2)
  4. Scales Homography back to full resolution transparently
"""
...
def main():
    parser = argparse.ArgumentParser(description="Robust Object Tracker V16v8 (Optimized Motion)")
    ...
    out_path = args.output or (Path(args.video).stem + "_tracked_v16v8.mp4")
    ...
    while True:
        ...
        # Display
        timing.start("imshow")
        cv2.imshow("Tracking V16v8", frame)
        timing.stop("imshow")
