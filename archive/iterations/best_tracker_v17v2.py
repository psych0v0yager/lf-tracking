"""
Robust Single Object Tracker - Version 17v2 (Balanced Speed/Accuracy)

Changes from v17:
- Increased resolution: 480px width (from 320px)
- Increased pyramid levels: 3 (from 2)
- Should recover last few frames while maintaining ~15+ FPS
"""
...
def main():
    parser = argparse.ArgumentParser(description="Robust Object Tracker V17v2 (Balanced Speed/Accuracy)")
    ...
    out_path = args.output or (Path(args.video).stem + "_tracked_v17v2.mp4")
    ...
    while True:
        ...
        # Display
        timing.start("imshow")
        cv2.imshow("Tracking V17v2", frame)
        timing.stop("imshow")
