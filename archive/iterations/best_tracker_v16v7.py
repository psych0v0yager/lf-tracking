"""
Robust Single Object Tracker - Version 16v7

Conservative optimization - only reduce feature points from 300 to 200.
Everything else same as v16v2 (the working baseline).

Usage:
    python best_tracker_v16v7.py test_track_dron1.mp4 1314 623 73 46
"""
...
class CameraMotionEstimator:
    def __init__(self):
        ...
        self.feature_params = dict(
            maxCorners=200,  # Reduced from 300 (conservative)
            qualityLevel=0.01,
            minDistance=20,
            blockSize=7
        )
...
def main():
    parser = argparse.ArgumentParser(description="Robust Object Tracker V16v7 with Timing")
    ...
    out_path = args.output or (Path(args.video).stem + "_tracked_v16v7.mp4")
    ...
    while True:
        ...
        # Display
        timing.start("imshow")
        cv2.imshow("Tracking V16v7", frame)
        timing.stop("imshow")
