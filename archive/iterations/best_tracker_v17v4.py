"""
Robust Single Object Tracker - Version 17v4 (KCF Tracker)

Changes from v17v2:
- KCF tracker instead of CSRT
- Expected: ~5ms tracker update (vs 31ms CSRT)
- Risk: KCF is less accurate, may lose drone
"""
...
def main():
    parser = argparse.ArgumentParser(description="Robust Object Tracker V17v4 (KCF Tracker)")
    ...
    out_path = args.output or (Path(args.video).stem + "_tracked_v17v4.mp4")
    ...
    while True:
        ...
        # Display
        timing.start("imshow")
        cv2.imshow("Tracking V17v4", frame)
        timing.stop("imshow")
