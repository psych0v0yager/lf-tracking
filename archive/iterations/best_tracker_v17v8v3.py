"""
Robust Single Object Tracker - Version 17v8v3 (Fast CSRT + Strict Recovery)

Changes from v17v8:
- Keep use_segmentation = False for speed
- Different strategy than v17v8v2: instead of triggering recovery easier,
  make recovery STRICTER to avoid false matches
- Higher recovery thresholds: 0.60/0.50 (was 0.55/0.35)
- Max recovery distance: reject if found >300px from last position
- Tighter size constraints: 80-120% (was 70-130%)
"""
...
def main():
    ...
    writer = None
    if not args.no_save:
        out_path = args.output or (Path(args.video).stem + "_tracked_v17v8v3.mp4")
