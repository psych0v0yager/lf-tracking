"""
Robust Single Object Tracker - Version 18 (MixFormerV2 + Motion Compensation)

Neural tracker using MixFormerV2-S with motion compensation from v17v9.
Designed for high-speed tracking on GPU with robustness to camera motion.
...
- Pyramidal recovery: Fast re-detection when lost
"""
...
class TemplateVerifier:
    """Template-based verification and recovery"""
    def __init__(self):
